...
export default {
  ...
  "blueprint.welcome_title": "Bem-vindo ao OpenWork",
  ...
  "model_picker.default_model_desc": "Escolha o modelo padrão para novos chats e ajuste os perfis de raciocínio no cartão antes de confirmar.",
  ...
  "scheduled.tpl_habit_checkin_desc": "Faça uma check-in rápido de hábitos ao longo do dia.",
  ...
  "settings.connect_opencode_hint": "Conecte-se ao OpenCode para carregar provedores.",
